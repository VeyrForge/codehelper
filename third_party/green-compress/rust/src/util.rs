...
pub fn print_help() {
    ...
    println!("  pack-model --gguf model.gguf --out model.green [--method green_optimal] [--requant none|q4_0|nvfp4|mxfp4]");
    println!("             [--tokenizer PATH] [--config PATH] [--clone-tied-output] [--verify]");
    println!("             dense-complete .green; auto requant (q4_0 production; none experimental; nvfp4/mxfp4 scaffold)");
    println!("             MoE → raw-f32 experts-*.greenpack");
}
