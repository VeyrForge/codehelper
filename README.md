...
Prebuilt **3.0.2** bundles (Linux, macOS, Windows) include `codehelper`, MCP server, **`ge` 1.0.0**, and **`greencompress` 1.0.0** on [GitHub Releases](https://github.com/VeyrForge/codehelper/releases).
