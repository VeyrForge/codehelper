...
var toolRefs = map[string]toolRef{
	...
	"db_query":                   {summary: "Read-only SQL against a configured sqlite profile.", params: "connection · sql · max_rows"},
	"db_schema":                  {summary: "Schema introspection for sqlite.", params: "connection · tables"},
