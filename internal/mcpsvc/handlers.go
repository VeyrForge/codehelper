...
// smoke tests, orchestration eval, and benchmarks. Product-gated tools are
// omitted when the corresponding module is disabled at compile time.
...
func coreToolHandlers(reg *registry.Registry) map[string]server.ToolHandlerFunc {
	return map[string]server.ToolHandlerFunc{
		...
		"search_hybrid":              searchHybridHandler(reg),
		"context_bundle":             contextBundleHandler(reg),
