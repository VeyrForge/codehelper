...
# Root docs/ is the vf overlay source (LICENSE/README/CI replacements).
# Never prune it. Only drop leftover public mirrors under vendored trees + qrels.
prune \
  third_party/green-engine/docs/public \
  third_party/green-compress/docs/public \
  docs/qrels
